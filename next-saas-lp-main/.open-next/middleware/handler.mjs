...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let { context: aw, propagation: ax, trace: ay, SpanStatusCode: az, SpanKind: aA, ROOT_CONTEXT: aB } = d = c(234);
      class aC extends Error {
        constructor(a10, b2) {
      ...
      let bs = ["/", "/feed", "/login", "/signup", "/signup/brand", "/signup/creator", "/forgot-password", "/terms", "/privacy", "/flow-generator", "/dashboard", "/tasks"];
      async function bt(a10) {
        let { pathname: b2 } = a10.nextUrl;
        if (bs.includes(b2) || /^\/flow-generator\/[a-f0-9-]{8,}/.test(b2) || /^\/users\/\d+/.test(b2) || b2.startsWith("/_next") || b2.startsWith("/api") || b2.startsWith("/static") || b2.startsWith("/images") || b2.includes(".")) return S.next();
        let c2 = a10.headers.get("cookie") || "";
        try {
          console.log("[Middleware] Checking auth for:", b2);
          let a11 = await fetch("http://127.0.0.1:8000/api/auth/me/", { method: "GET", headers: { cookie: c2, "Content-Type": "application/json" }, cache: "no-store" });
          if (console.log("[Middleware] Auth response status:", a11.status), a11.ok) {
            let b3 = await a11.json();
            return console.log("[Middleware] User authenticated:", b3.email), S.next();
          }
        } catch (a11) {
          console.error("[Middleware] Auth check failed:", a11);
        }
        console.log("[Middleware] Redirecting to login from:", b2);
        let d2 = new URL("/login", a10.url);
        return "/login" === b2 || "/signup" === b2 || b2.startsWith("/signup/") || d2.searchParams.set("redirect", b2), S.redirect(d2);
      }
...
var NextConfig = { "env": {}, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": true, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.js", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [{ "protocol": "https", "hostname": "**" }, { "protocol": "http", "hostname": "127.0.0.1" }, { "protocol": "http", "hostname": "localhost" }], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "E:\\Gemnar-com\\next-saas-lp-main", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 11, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "serverActions": { "bodySizeLimit": "10mb" }, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.js", "turbopack": { "root": "E:\\Gemnar-com\\next-saas-lp-main" } };
var BuildId = "vb-yx_TyxxGGZXYnbzNGm";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/auth/instagram/callback", "regex": "^/auth/instagram/callback(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/instagram/callback(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/dashboard/analytics", "regex": "^/dashboard/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/analytics(?:/)?$" }, { "page": "/dashboard/analytics/events", "regex": "^/dashboard/analytics/events(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/analytics/events(?:/)?$" }, { "page": "/dashboard/analytics/pages", "regex": "^/dashboard/analytics/pages(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/analytics/pages(?:/)?$" }, { "page": "/dashboard/analytics/sessions", "regex": "^/dashboard/analytics/sessions(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/analytics/sessions(?:/)?$" }, { "page": "/dashboard/brands", "regex": "^/dashboard/brands(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/brands(?:/)?$" }, { "page": "/dashboard/brands/acme-corp", "regex": "^/dashboard/brands/acme\\-corp(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/brands/acme\\-corp(?:/)?$" }, { "page": "/dashboard/brands/acme-corp/settings", "regex": "^/dashboard/brands/acme\\-corp/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/brands/acme\\-corp/settings(?:/)?$" }, { "page": "/dashboard/chat", "regex": "^/dashboard/chat(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/chat(?:/)?$" }, { "page": "/dashboard/chat/conversations", "regex": "^/dashboard/chat/conversations(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/chat/conversations(?:/)?$" }, { "page": "/dashboard/chat/new", "regex": "^/dashboard/chat/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/chat/new(?:/)?$" }, { "page": "/dashboard/crm", "regex": "^/dashboard/crm(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/crm(?:/)?$" }, { "page": "/dashboard/crm/companies", "regex": "^/dashboard/crm/companies(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/crm/companies(?:/)?$" }, { "page": "/dashboard/crm/contacts", "regex": "^/dashboard/crm/contacts(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/crm/contacts(?:/)?$" }, { "page": "/dashboard/crm/deals", "regex": "^/dashboard/crm/deals(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/crm/deals(?:/)?$" }, { "page": "/dashboard/instagram/connect", "regex": "^/dashboard/instagram/connect(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/instagram/connect(?:/)?$" }, { "page": "/dashboard/instagram/queue", "regex": "^/dashboard/instagram/queue(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/instagram/queue(?:/)?$" }, { "page": "/dashboard/organizations", "regex": "^/dashboard/organizations(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/organizations(?:/)?$" }, { "page": "/dashboard/profile", "regex": "^/dashboard/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/profile(?:/)?$" }, { "page": "/dashboard/profile/billing", "regex": "^/dashboard/profile/billing(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/profile/billing(?:/)?$" }, { "page": "/dashboard/settings", "regex": "^/dashboard/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/settings(?:/)?$" }, { "page": "/dashboard/tasks", "regex": "^/dashboard/tasks(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/tasks(?:/)?$" }, { "page": "/dashboard/tasks/all", "regex": "^/dashboard/tasks/all(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/tasks/all(?:/)?$" }, { "page": "/dashboard/tasks/create", "regex": "^/dashboard/tasks/create(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/tasks/create(?:/)?$" }, { "page": "/dashboard/twitter/analytics", "regex": "^/dashboard/twitter/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/twitter/analytics(?:/)?$" }, { "page": "/dashboard/twitter/config", "regex": "^/dashboard/twitter/config(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/twitter/config(?:/)?$" }, { "page": "/dashboard/twitter/history", "regex": "^/dashboard/twitter/history(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/twitter/history(?:/)?$" }, { "page": "/dashboard/twitter/queue", "regex": "^/dashboard/twitter/queue(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/twitter/queue(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/feed", "regex": "^/feed(?:/)?$", "routeKeys": {}, "namedRegex": "^/feed(?:/)?$" }, { "page": "/flow-generator", "regex": "^/flow\\-generator(?:/)?$", "routeKeys": {}, "namedRegex": "^/flow\\-generator(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/signup", "regex": "^/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup(?:/)?$" }, { "page": "/signup/brand", "regex": "^/signup/brand(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup/brand(?:/)?$" }, { "page": "/signup/creator", "regex": "^/signup/creator(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup/creator(?:/)?$" }], "dynamic": [{ "page": "/api/brands/[slug]", "regex": "^/api/brands/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/brands/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/dashboard/brands/[slug]", "regex": "^/dashboard/brands/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/dashboard/brands/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/dashboard/brands/[slug]/analytics", "regex": "^/dashboard/brands/([^/]+?)/analytics(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/dashboard/brands/(?<nxtPslug>[^/]+?)/analytics(?:/)?$" }, { "page": "/dashboard/brands/[slug]/instagram", "regex": "^/dashboard/brands/([^/]+?)/instagram(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/dashboard/brands/(?<nxtPslug>[^/]+?)/instagram(?:/)?$" }, { "page": "/dashboard/brands/[slug]/twitter", "regex": "^/dashboard/brands/([^/]+?)/twitter(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/dashboard/brands/(?<nxtPslug>[^/]+?)/twitter(?:/)?$" }, { "page": "/dashboard/brands/[slug]/twitter/config", "regex": "^/dashboard/brands/([^/]+?)/twitter/config(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/dashboard/brands/(?<nxtPslug>[^/]+?)/twitter/config(?:/)?$" }, { "page": "/dashboard/organizations/[id]", "regex": "^/dashboard/organizations/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/organizations/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/dashboard/tasks/[id]", "regex": "^/dashboard/tasks/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/tasks/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/flow-generator/[slug]", "regex": "^/flow\\-generator/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/flow\\-generator/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/users/[id]", "regex": "^/users/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/users/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/auth/instagram/callback": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/instagram/callback", "dataRoute": "/auth/instagram/callback.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/analytics/events": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/analytics/events", "dataRoute": "/dashboard/analytics/events.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/analytics/sessions": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/analytics/sessions", "dataRoute": "/dashboard/analytics/sessions.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/analytics/pages": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/analytics/pages", "dataRoute": "/dashboard/analytics/pages.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/analytics": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/analytics", "dataRoute": "/dashboard/analytics.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/brands/acme-corp": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/brands/acme-corp", "dataRoute": "/dashboard/brands/acme-corp.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/chat/conversations": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/chat/conversations", "dataRoute": "/dashboard/chat/conversations.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/brands": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/brands", "dataRoute": "/dashboard/brands.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/chat/new": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/chat/new", "dataRoute": "/dashboard/chat/new.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/crm/contacts": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/crm/contacts", "dataRoute": "/dashboard/crm/contacts.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/crm": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/crm", "dataRoute": "/dashboard/crm.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/instagram/connect": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/instagram/connect", "dataRoute": "/dashboard/instagram/connect.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/signup/brand": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/signup/brand", "dataRoute": "/signup/brand.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/instagram/queue": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/instagram/queue", "dataRoute": "/dashboard/instagram/queue.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/crm/deals": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/crm/deals", "dataRoute": "/dashboard/crm/deals.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard", "dataRoute": "/dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/signup/creator": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/signup/creator", "dataRoute": "/signup/creator.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/signup": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/signup", "dataRoute": "/signup.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/profile/billing": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/profile/billing", "dataRoute": "/dashboard/profile/billing.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/profile": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/profile", "dataRoute": "/dashboard/profile.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/settings", "dataRoute": "/dashboard/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/organizations": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/organizations", "dataRoute": "/dashboard/organizations.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/tasks": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/tasks", "dataRoute": "/dashboard/tasks.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/twitter/analytics": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/twitter/analytics", "dataRoute": "/dashboard/twitter/analytics.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/twitter/config": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/twitter/config", "dataRoute": "/dashboard/twitter/config.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/twitter/history": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/twitter/history", "dataRoute": "/dashboard/twitter/history.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/tasks/all": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/tasks/all", "dataRoute": "/dashboard/tasks/all.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/twitter/queue": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/twitter/queue", "dataRoute": "/dashboard/twitter/queue.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/feed": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/feed", "dataRoute": "/feed.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/tasks/create": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/tasks/create", "dataRoute": "/dashboard/tasks/create.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/brands/acme-corp/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/brands/acme-corp/settings", "dataRoute": "/dashboard/brands/acme-corp/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/chat": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/chat", "dataRoute": "/dashboard/chat.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard/crm/companies": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard/crm/companies", "dataRoute": "/dashboard/crm/companies.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/flow-generator": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/flow-generator", "dataRoute": "/flow-generator.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "7be73c813a5ba9ea85f2a70087c708c4", "previewModeSigningKey": "2a3a322e9e1e35e8c73b923c8ea72a718663cd3929236b2b74c498014ceaaae9", "previewModeEncryptionKey": "a488e655a275f6239dcf4fcebf8f9b41249b08a97e170864ba69914df96ec3c7" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "vb-yx_TyxxGGZXYnbzNGm", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "iKBCb6EkhgKXn4vGM9vLLW/l9W5100ljOInFVh17b2w=", "__NEXT_PREVIEW_MODE_ID": "7be73c813a5ba9ea85f2a70087c708c4", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "2a3a322e9e1e35e8c73b923c8ea72a718663cd3929236b2b74c498014ceaaae9", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "a488e655a275f6239dcf4fcebf8f9b41249b08a97e170864ba69914df96ec3c7" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/brands/[slug]/route": "/api/brands/[slug]", "/api/brands/route": "/api/brands", "/api/users/my-uploads/route": "/api/users/my-uploads", "/favicon.ico/route": "/favicon.ico", "/(auth)/signup/brand/page": "/signup/brand", "/(auth)/login/page": "/login", "/(auth)/signup/creator/page": "/signup/creator", "/(auth)/signup/page": "/signup", "/page": "/", "/auth/instagram/callback/page": "/auth/instagram/callback", "/users/[id]/page": "/users/[id]", "/(dashboard)/dashboard/analytics/sessions/page": "/dashboard/analytics/sessions", "/(dashboard)/dashboard/analytics/page": "/dashboard/analytics", "/(dashboard)/dashboard/analytics/events/page": "/dashboard/analytics/events", "/(dashboard)/dashboard/analytics/pages/page": "/dashboard/analytics/pages", "/(dashboard)/dashboard/brands/[slug]/analytics/page": "/dashboard/brands/[slug]/analytics", "/(dashboard)/dashboard/brands/[slug]/page": "/dashboard/brands/[slug]", "/(dashboard)/dashboard/brands/[slug]/twitter/config/page": "/dashboard/brands/[slug]/twitter/config", "/(dashboard)/dashboard/brands/[slug]/instagram/page": "/dashboard/brands/[slug]/instagram", "/(dashboard)/dashboard/brands/acme-corp/page": "/dashboard/brands/acme-corp", "/(dashboard)/dashboard/brands/acme-corp/settings/page": "/dashboard/brands/acme-corp/settings", "/(dashboard)/dashboard/chat/conversations/page": "/dashboard/chat/conversations", "/(dashboard)/dashboard/brands/[slug]/twitter/page": "/dashboard/brands/[slug]/twitter", "/(dashboard)/dashboard/chat/new/page": "/dashboard/chat/new", "/(dashboard)/dashboard/crm/contacts/page": "/dashboard/crm/contacts", "/(dashboard)/dashboard/brands/page": "/dashboard/brands", "/(dashboard)/dashboard/chat/page": "/dashboard/chat", "/(dashboard)/dashboard/crm/companies/page": "/dashboard/crm/companies", "/(dashboard)/dashboard/crm/deals/page": "/dashboard/crm/deals", "/(dashboard)/dashboard/instagram/queue/page": "/dashboard/instagram/queue", "/(dashboard)/dashboard/organizations/page": "/dashboard/organizations", "/(dashboard)/dashboard/page": "/dashboard", "/(dashboard)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(dashboard)/dashboard/crm/page": "/dashboard/crm", "/(dashboard)/dashboard/instagram/connect/page": "/dashboard/instagram/connect", "/(dashboard)/dashboard/profile/page": "/dashboard/profile", "/(dashboard)/dashboard/profile/billing/page": "/dashboard/profile/billing", "/(dashboard)/dashboard/tasks/all/page": "/dashboard/tasks/all", "/(dashboard)/dashboard/tasks/[id]/page": "/dashboard/tasks/[id]", "/(dashboard)/dashboard/settings/page": "/dashboard/settings", "/(dashboard)/dashboard/tasks/create/page": "/dashboard/tasks/create", "/(dashboard)/dashboard/twitter/analytics/page": "/dashboard/twitter/analytics", "/(dashboard)/dashboard/twitter/config/page": "/dashboard/twitter/config", "/(dashboard)/feed/page": "/feed", "/(dashboard)/dashboard/twitter/history/page": "/dashboard/twitter/history", "/(dashboard)/flow-generator/[slug]/page": "/flow-generator/[slug]", "/(dashboard)/dashboard/tasks/page": "/dashboard/tasks", "/(dashboard)/flow-generator/page": "/flow-generator", "/(dashboard)/dashboard/twitter/queue/page": "/dashboard/twitter/queue" };
