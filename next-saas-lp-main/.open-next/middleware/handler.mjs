...
var BuildId = "Pdw5wJ3XaZ6urDd-CgVWC";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "Pdw5wJ3XaZ6urDd-CgVWC", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "iKBCb6EkhgKXn4vGM9vLLW/l9W5100ljOInFVh17b2w=", "__NEXT_PREVIEW_MODE_ID": "7be73c813a5ba9ea85f2a70087c708c4", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "2a3a322e9e1e35e8c73b923c8ea72a718663cd3929236b2b74c498014ceaaae9", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "a488e655a275f6239dcf4fcebf8f9b41249b08a97e170864ba69914df96ec3c7" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/brands/route": "/api/brands", "/api/users/my-uploads/route": "/api/users/my-uploads", "/api/brands/[slug]/route": "/api/brands/[slug]", "/favicon.ico/route": "/favicon.ico", "/(auth)/login/page": "/login", "/(auth)/signup/brand/page": "/signup/brand", "/(auth)/signup/creator/page": "/signup/creator", "/(auth)/signup/page": "/signup", "/page": "/", "/auth/instagram/callback/page": "/auth/instagram/callback", "/users/[id]/page": "/users/[id]", "/(dashboard)/dashboard/analytics/events/page": "/dashboard/analytics/events", "/(dashboard)/dashboard/analytics/pages/page": "/dashboard/analytics/pages", "/(dashboard)/dashboard/analytics/sessions/page": "/dashboard/analytics/sessions", "/(dashboard)/dashboard/analytics/page": "/dashboard/analytics", "/(dashboard)/dashboard/brands/[slug]/analytics/page": "/dashboard/brands/[slug]/analytics", "/(dashboard)/dashboard/brands/[slug]/instagram/page": "/dashboard/brands/[slug]/instagram", "/(dashboard)/dashboard/brands/[slug]/page": "/dashboard/brands/[slug]", "/(dashboard)/dashboard/brands/[slug]/twitter/config/page": "/dashboard/brands/[slug]/twitter/config", "/(dashboard)/dashboard/brands/[slug]/twitter/page": "/dashboard/brands/[slug]/twitter", "/(dashboard)/dashboard/brands/acme-corp/page": "/dashboard/brands/acme-corp", "/(dashboard)/dashboard/brands/page": "/dashboard/brands", "/(dashboard)/dashboard/brands/acme-corp/settings/page": "/dashboard/brands/acme-corp/settings", "/(dashboard)/dashboard/chat/conversations/page": "/dashboard/chat/conversations", "/(dashboard)/dashboard/chat/new/page": "/dashboard/chat/new", "/(dashboard)/dashboard/chat/page": "/dashboard/chat", "/(dashboard)/dashboard/crm/companies/page": "/dashboard/crm/companies", "/(dashboard)/dashboard/crm/deals/page": "/dashboard/crm/deals", "/(dashboard)/dashboard/crm/page": "/dashboard/crm", "/(dashboard)/dashboard/crm/contacts/page": "/dashboard/crm/contacts", "/(dashboard)/dashboard/instagram/connect/page": "/dashboard/instagram/connect", "/(dashboard)/dashboard/instagram/queue/page": "/dashboard/instagram/queue", "/(dashboard)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(dashboard)/dashboard/organizations/page": "/dashboard/organizations", "/(dashboard)/dashboard/page": "/dashboard", "/(dashboard)/dashboard/profile/billing/page": "/dashboard/profile/billing", "/(dashboard)/dashboard/profile/page": "/dashboard/profile", "/(dashboard)/dashboard/tasks/[id]/page": "/dashboard/tasks/[id]", "/(dashboard)/dashboard/settings/page": "/dashboard/settings", "/(dashboard)/dashboard/tasks/all/page": "/dashboard/tasks/all", "/(dashboard)/dashboard/tasks/create/page": "/dashboard/tasks/create", "/(dashboard)/dashboard/tasks/page": "/dashboard/tasks", "/(dashboard)/dashboard/twitter/analytics/page": "/dashboard/twitter/analytics", "/(dashboard)/dashboard/twitter/config/page": "/dashboard/twitter/config", "/(dashboard)/dashboard/twitter/history/page": "/dashboard/twitter/history", "/(dashboard)/dashboard/twitter/queue/page": "/dashboard/twitter/queue", "/(dashboard)/feed/page": "/feed", "/(dashboard)/flow-generator/[slug]/page": "/flow-generator/[slug]", "/(dashboard)/flow-generator/page": "/flow-generator" };
