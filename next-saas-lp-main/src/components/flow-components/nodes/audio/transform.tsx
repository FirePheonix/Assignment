...
import { generateAudioFromText } from '@/lib/api/audio-generation';
...
export const AudioTransform = ({
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Call Django backend API directly from client
      const result = await generateAudioFromText({
        text,
        voice: data.voice,
        output_format: 'mp3_44100_128', // Default to high-quality MP3
      });
