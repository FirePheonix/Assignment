...
import {
  AIMessage,
  AIMessageContent,
} from '@/components/flow-components/ui/kibo-ui/ai/message';
import { AIResponse } from '@/components/flow-components/ui/kibo-ui/ai/response';
import {
  AISource,
  AISources,
  AISourcesContent,
  AISourcesTrigger,
} from '@/components/flow-components/ui/kibo-ui/ai/source';
...
export const TextTransform = ({
  ...
  const handleGenerate = useCallback(async () => {
    ...
    console.log('📝 TEXT NODE GENERATING:', {
      nodeId: id,
      nodeType: type,
      incomingNodes: incomers,
      textPrompts,
      audioPrompts,
      images,
      imageDescriptions,
