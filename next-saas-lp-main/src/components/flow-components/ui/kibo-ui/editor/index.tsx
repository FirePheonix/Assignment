...
import {
  ...
  CommandItem,
  CommandList,
} from '@/components/flow-components/ui/command';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@/components/flow-components/ui/dropdown-menu';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@/components/flow-components/ui/popover';
import { Separator } from '@/components/flow-components/ui/separator';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from '@/components/flow-components/ui/tooltip';
...
import { BubbleMenu, type BubbleMenuProps } from '@tiptap/extension-bubble-menu';
import { FloatingMenu, type FloatingMenuProps } from '@tiptap/extension-floating-menu';
