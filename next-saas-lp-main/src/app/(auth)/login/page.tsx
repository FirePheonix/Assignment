  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Validate redirect - don't redirect to auth pages or invalid routes
        if (redirect === '/login' || redirect === '/signup' || redirect.startsWith('/signup/')) {
          redirect = '/dashboard';
        }
    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          {/* Logo */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">GEMNAR</h1>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 bg-white/5 border border-white/10 hover:bg-white/10 rounded-lg px-4 py-3 transition-colors">
